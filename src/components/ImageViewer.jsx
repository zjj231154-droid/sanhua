...
export default function ImageViewer({ src, alt = '生成图片', downloadUrl, downloadName, onClose }) {
  ...
  return <div className="image-viewer" role="dialog" aria-modal="true" aria-label="图片查看器">
    ...
    <button className="image-viewer-close" onClick={onClose} aria-label="关闭图片查看器" title="关闭预览"><X size={20} /></button>
  </div>
}
