export const CLOUD_ASSETS = [
  ...
  ...Array.from({ length: 4 }, (_, index) => ({ id: `coffee-product-${index + 1}`, name: `咖啡产品 ${index + 1}`, category: 'retouch', group: '咖啡产品图', url: `/cloud-assets/retouch/coffee-products/coffee-product-${String(index + 1).padStart(2, '0')}.jpg` })),
