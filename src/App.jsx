...
function CreativeCasesPage({ type }) {
  ...
  async function generateBrandImage(requestedName = '') {
    ...
    try {
      ...
      const body = { workspace: 'brand', model: 'gpt-image-2', prompt: finalPrompt, count: 1, size: '1024x1024', title: '品牌创作', requestedName, promptSummary: finalPrompt, sourceAssetIds: selectedAsset ? [selectedAsset.id] : [], referenceAssetIds: selectedAsset ? [selectedAsset.id] : [] }
